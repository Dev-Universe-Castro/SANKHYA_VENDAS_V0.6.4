...
export async function listarPedidos(codVend?: string, dataInicio?: string, dataFim?: string): Promise<PedidoListagem[]> {
  try {
...
export async function listarPedidosPorGerente(codGerente: string, dataInicio?: string, dataFim?: string): Promise<PedidoListagem[]> {
  try {
